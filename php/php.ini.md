...
[输出缓冲4m,如超出分块输出，最后发送头部及cookies,CLI下关闭]
...
[开启后，每次使用print()，echo() 等函数 或每个HTML块之后， 调用PHP中的flush()函数]
implicit_flush = Off
...
[opcache]
;zend_extension="D:/amp/php7.0.18/ext/php_opcache.dll"
...
[Xdebug]  
;指定Xdebug扩展文件的绝对路径  
zend_extension="D:/amp/php7.0.18/ext/php_xdebug-2.5.3-7.0-vc14-x86_64.dll"  
;启用性能检测分析  
...
;指定堆栈跟踪文件的存放目录  
xdebug.trace_output_dir="D:/amp/debug"  
;指定性能分析文件的存放目录  
xdebug.profiler_output_dir="D:/amp/debug"  
